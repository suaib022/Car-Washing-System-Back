...
export const initiatePayment = async (paymentData: TPaymentData) => {
  const response = await axios.post(config.aamarpay_payment_url as string, {
    ...
    success_url: `https://car-wash-back.vercel.app/api/bookings/payment/confirmation?bookingId=${paymentData.bookingId}&transactionId=${paymentData.transactionId}&status=success`,
    fail_url: `https://car-wash-back.vercel.app/api/bookings/payment/confirmation?status=failed`,
    cancel_url: 'https://echowash.vercel.app',
